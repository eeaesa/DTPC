...
class LAHeart(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == "val":
            ...
            sample = {"image": image.float(), "label": label.long()}
            return sample

class LAHeart_DTPC(Dataset):
    """LA Dataset"""

    def __init__(
        self, base_dir=None, mode="train", num=None,
            transform=None, id_path=None
    ):
        self._base_dir = base_dir
        self.transform = transform
        self.sample_list = []
    ...
    def __getitem__(self, idx):
        ...
        img_w, img_s = deepcopy(image), deepcopy(image)
        ...
        sample = {"image_weak": img_w, "image_strong": img_s}
        return sample
